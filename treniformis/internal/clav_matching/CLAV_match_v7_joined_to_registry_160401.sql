SELECT
  a.mmsi AS mmsi,
  b.shiptype AS shiptype,
  STRING(a.match_start) AS valid_from,
  STRING(a.match_end) AS valid_to,
  b.shipname AS shipname,
  b.geartype AS geartype,
  b.flag AS flag,
  b.callsign AS callsign,
  b.imo AS imo,
  b.tonnage AS tonnage,
  b.length AS length,
  b.national_id AS national_id,
  b.rfmo_id AS rfmo_id,
  b.rfmo_name AS rank_name,
  b.notes AS notes,
  b.clav_VRMFID AS clav_VRMFID,
  STRING(b.clav_DateUpdated) AS clav_DateUpdated,
  b.clav_TUVI AS clav_TUVI,
  b.clav_FlagCode AS clav_FlagCode,
  b.clav_ParentVesselTypeCode AS clav_ParentVesselTypeCode,
  b.clav_ParentVesselType AS clav_ParentVesselType,
  b.clav_VesselTypeCode AS clav_VesselTypeCode,
  b.clav_GearTypeCode AS clav_GearTypeCode,
  b.clav_LengthTypeCode AS clav_LengthTypeCode,
  b.clav_TonnageTypeCode AS clav_TonnageTypeCode,
  b.clav_PreviousName AS clav_PreviousName,
  STRING(b.clav_PreviousNameDate) AS clav_PreviousNameDate,
  b.clav_PreviousFlagCode AS clav_PreviousFlagCode,
  STRING(b.clav_PreviousFlagCodeDate) AS clav_PreviousFlagCodeDate,
  b.clav_AutStatus AS clav_AutStatus,
  STRING(b.clav_DateAutStart) AS clav_DateAutStart,
  STRING(b.clav_DateAutEnd) AS clav_DateAutEnd,
  STRING(b.clav_DateAutTerm) AS clav_DateAutTerm,
  b.clav_AutTermCode AS clav_AutTermCode,
  b.clav_AutTermDescription AS clav_AutTermDescription,
  b.clav_AutTermReason AS clav_AutTermReason,
  b.clav_URLID AS clav_URLID
FROM (
  SELECT
    *
  FROM (
            ...
            FROM (
              ...
              FROM (
                          ...
                          FROM (
                            ...
                            FROM (
                              SELECT
                                *
                              FROM
                                [Registry_matching_sources.CLAV_cons_imo2_NORM]
                              WHERE
                          ...
                          FROM (
                            ...
                            LEFT JOIN (
                              SELECT
                                ...
                                last_timestamp
                              FROM
                                [Vessel_identity_messages.norm_shipname_rank_mmsi_cnt_NORM]
                              WHERE
                ...
                LEFT JOIN (
                  ...
                  FROM
                    [Vessel_identity_messages.type5_24_2012_2015_NORM]
                  WHERE
                    type IN (5,
                      24)
  ...
  WHERE
    ...
    AND ((imo_rank != 0
      ...
      OR (imo_rank !=0
        AND flag_match = 1) )
    AND match_end > '2015-01-31 00:00:00') a
LEFT JOIN (
  SELECT
    *
  FROM
